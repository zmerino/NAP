...
for j = 1:length(distribution_vector)
    ...
    % WALL TIME
    temp = utils.reshape_groups(sample_vec',wall_vec_se);
    ...
    dist_table = table(distribution, name, estimator, sample_power, wall_time, cpu_time, fail, lagrange, blocksize, blockscale);
