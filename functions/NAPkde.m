...
%         p6 = 0.0625;
    ...
    properties
        % possible outputs
        p = [NAPkde.p1,NAPkde.p2,NAPkde.p3,NAPkde.p4,NAPkde.p5,NAPkde.p6,NAPkde.p7,NAPkde.p8];
        failed;
        sx;
        sPDF;
        sCDF;
...
%                     [targetBlock{t,b}.data(:,2),targetBlock{t,b}.data(:,1)] = ksdensity(MatPDFsample{b});
                    targetBlock{t,b}.data(:,3) = utils_analysis.trapz(targetBlock{t,b}.data(:,1), targetBlock{t,b}.data(:,2));
                end
            end
