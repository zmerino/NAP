...
void OutputControl::displayOnMATLAB(std::shared_ptr<matlab::engine::MATLABEngine> matlabPtr, std::string message) {
 ...
 void OutputControl::printDebug(string output) { 
     debug = true;
     displayOnMATLAB(matlabPtr, output); 
     debug = false;
 }
 
 void OutputControl::printDebug(string output, int value) {
     ostringstream strOut;
     strOut << output << ": " << value;                                      
     printDebug(strOut.str());
 }

  void OutputControl::printDebug(string output, double value) { 
     ostringstream strOut;
     strOut << output << ": " << value;                                      
     printDebug(strOut.str());
 }
