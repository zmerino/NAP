...
% Import data table
file_dir = fullfile('data_many_cpu');
write_data = fullfile('data_many_cpu', 'meta_data_100.dat');
...
distribution_vector = ["Trimodal-Normal","Uniform","Normal","Generalized-Pareto"];
